...
param settings {
	...
	@sealed()
	properties: {
		@description('Specifies whether to enable a single data endpoint per region for serving data. Applies only to the Premium SKU.')
		...
		@description('Specifies whether Tasks are allowed to bypass the network rules for this container registry. Requires: sku.name == \'Premium\'.')
