...
param settings {
	...
	@sealed()
	name: {
		@description('The name of the Microsoft.OperationalInsights/workspaces resource.')
		workspace: resourceInput<'Microsoft.OperationalInsights/workspaces@2025-07-01'>.name
		@description('The table name. Must end with "_CL" to denote a custom log table.')
		@maxLength(63)
		@minLength(4)
		table: resourceInput<'Microsoft.OperationalInsights/workspaces/tables@2025-07-01'>.name
	}
